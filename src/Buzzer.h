...
const unsigned int soundLastTestStripSecond1[] = { 1, 587, 500 };
const unsigned int soundLastTestStripSecond2[] = { 1, 698, 500 };
...
const unsigned int soundFocusOff[] = { 1, 220, 100 };
